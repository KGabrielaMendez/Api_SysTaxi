...
<div class="form-group">
    <input type="text" name="DIRECCION_ENC" readonly="true" class="form-control" value="<?php echo $DIRECCION_ENC?>" />
</div>
<label style="text-transform: capitalize; width: 150px; font-weight: bold;">FECHA ENC</label>
<div class="form-group">
    <input type="date" class="form-control" id="datepicker" readonly="true" name="FECHA_ENC"  value="<?php echo $FECHA_ENC?>" />
</div>
