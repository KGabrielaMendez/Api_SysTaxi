...
$sqlV = 'SELECT IDTIPOENCOM, ID_PEDIDO, DESCRIPCION_ENC, DISTANCIAMIN_ENC, TIEMPOESPERAMIN_ENC, PESOMAXKG_ENC, COSTOENC_MAX_ENC, LATITUD_ENC, LONGITUD_ENC, DIRECCION_ENC, ID_ENCOMIENDA FROM cat_encomienda WHERE ID_ENCOMIENDA="'.$id.'"';
...
$msg = isset($msg) ? $msg : '';
$id = isset($_REQUEST['ID_ENCOMIENDA']) ? $_REQUEST['ID_ENCOMIENDA'] : '';
$sqlE = 'SELECT IDTIPOENCOM, ID_PEDIDO, DESCRIPCION_ENC, DISTANCIAMIN_ENC, TIEMPOESPERAMIN_ENC, PESOMAXKG_ENC, COSTOENC_MAX_ENC, LATITUD_ENC, LONGITUD_ENC, DIRECCION_ENC, ID_ENCOMIENDA FROM cat_encomienda WHERE ID_ENCOMIENDA="'.$id.'"';
...
$sqlU = "UPDATE cat_encomienda SET IDTIPOENCOM= '$IDTIPOENCOM', ID_PEDIDO= '$ID_PEDIDO', DESCRIPCION_ENC= '$DESCRIPCION_ENC', DISTANCIAMIN_ENC= '$DISTANCIAMIN_ENC', TIEMPOESPERAMIN_ENC= '$TIEMPOESPERAMIN_ENC', PESOMAXKG_ENC= '$PESOMAXKG_ENC', COSTOENC_MAX_ENC= '$COSTOENC_MAX_ENC', LATITUD_ENC= '$LATITUD_ENC', LONGITUD_ENC= '$LONGITUD_ENC', DIRECCION_ENC= '$DIRECCION_ENC' WHERE ID_ENCOMIENDA= '$id'";
...
$LONGITUD_ENC = isset($_REQUEST['LONGITUD_ENC']) ? addslashes($_REQUEST['LONGITUD_ENC']) : '';
$DIRECCION_ENC = isset($_REQUEST['DIRECCION_ENC']) ? addslashes($_REQUEST['DIRECCION_ENC']) : '';
$sqlI = "INSERT INTO cat_encomienda (IDTIPOENCOM, ID_PEDIDO, DESCRIPCION_ENC, DISTANCIAMIN_ENC, TIEMPOESPERAMIN_ENC, PESOMAXKG_ENC, COSTOENC_MAX_ENC, LATITUD_ENC, LONGITUD_ENC, DIRECCION_ENC) VALUES ('$IDTIPOENCOM', '$ID_PEDIDO', '$DESCRIPCION_ENC', '$DISTANCIAMIN_ENC', '$TIEMPOESPERAMIN_ENC', '$PESOMAXKG_ENC', '$COSTOENC_MAX_ENC', '$LATITUD_ENC', '$LONGITUD_ENC', '$DIRECCION_ENC')";
...
$sqlL = 'SELECT IDTIPOENCOM, ID_PEDIDO, DESCRIPCION_ENC, DISTANCIAMIN_ENC, TIEMPOESPERAMIN_ENC, PESOMAXKG_ENC, COSTOENC_MAX_ENC, LATITUD_ENC, LONGITUD_ENC, DIRECCION_ENC, ID_ENCOMIENDA FROM cat_encomienda';
