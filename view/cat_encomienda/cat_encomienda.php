...
//$LONGITUD_ENC = isset($_REQUEST['LONGITUD_ENC']) ? addslashes($_REQUEST['LONGITUD_ENC']) : '';
$DIRECCION_ENC = isset($_REQUEST['DIRECCION_ENC']) ? addslashes($_REQUEST['DIRECCION_ENC']) : '';
$sqlI = "INSERT INTO cat_encomienda (IDTIPOENCOM, ID_PEDIDO, DESCRIPCION_ENC, DISTANCIAMIN_ENC, TIEMPOESPERAMIN_ENC, PESOMAXKG_ENC, COSTOENC_MAX_ENC, DIRECCION_ENC) VALUES ('$IDTIPOENCOM', '$ID_PEDIDO', '$DESCRIPCION_ENC', '$DISTANCIAMIN_ENC', '$TIEMPOESPERAMIN_ENC', '$PESOMAXKG_ENC', '$COSTOENC_MAX_ENC','$DIRECCION_ENC')";
