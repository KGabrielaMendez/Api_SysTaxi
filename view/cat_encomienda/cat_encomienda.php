...
$DIRECCION_ENC = isset($_REQUEST['DIRECCION_ENC']) ? addslashes($_REQUEST['DIRECCION_ENC']) : '';
$FECHA_ENC = isset($_REQUEST['FECHA_ENC']) ? addslashes($_REQUEST['FECHA_ENC']) : '';
$sqlI = "INSERT INTO cat_encomienda (ID_US, IDCONDUCTOR, TIPO_ENCOMIENDA, DESCRIPCION_ENC, DISTANCIAMIN_ENC, TIEMPOESPERAMIN_ENC, COSTOENC_MAX_ENC, LATITUD_ORIG, LONGITUD_ORIG, LATITUD_DEST, LONGITUD_DEST, DIRECCION_ENC, FECHA_ENC) VALUES ('$ID_US', '$IDCONDUCTOR', '$TIPO_ENCOMIENDA', '$DESCRIPCION_ENC', '$DISTANCIAMIN_ENC', '$TIEMPOESPERAMIN_ENC', '$COSTOENC_MAX_ENC', '$LATITUD_ORIG', '$LONGITUD_ORIG', '$LATITUD_DEST', '$LONGITUD_DEST', '$DIRECCION_ENC', '$FECHA_ENC')";
