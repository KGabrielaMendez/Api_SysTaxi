...
$sqlL = 'SELECT e.ID_US, u.NOMBRE_US,IDCONDUCTOR,E.ESTADO , TIPO_ENCOMIENDA, DESCRIPCION_ENC, DISTANCIAMIN_ENC, TIEMPOESPERAMIN_ENC, COSTOENC_MAX_ENC, LATITUD_ORIG, LONGITUD_ORIG, LATITUD_DEST, LONGITUD_DEST, DIRECCION_ENC, FECHA_ENC, ID_ENCOMIENDA FROM cat_encomienda e, cat_usuarios u where e.ID_US=u.ID_US';
