...
<!--            <select name="ID_US" class="locationMultiple form-control">
            ...
            <select name="ID_US" style="width:100%; height: 40px">
                <?php
                $mysqli = mysqli_connect('localhost', 'root', '', 'systaxi');
                $consultas = "SELECT NOMBRE_US, ID_US from cat_usuarios";
                if ($res = mysqli_query($mysqli, $consultas)) {
        ...
        <div class="form-group">
            ...
            <select name="ID_UNI" style="width:100%; height: 40px">
                <?php
                $mysqli = mysqli_connect('localhost', 'root', '', 'systaxi');
