...
<td><?php //echo $result[$key]['EMAIL_US']?></td>-->
<td><a href="cat_cliente.php?option=view&USERNAME=<?php echo $result[$key]['USERNAME']?>"><i class="fa fa-eye"></i></a>&nbsp;|&nbsp;<a href="cat_cliente.php?option=edit&USERNAME=<?php echo $result[$key]['USERNAME']?>"><i class="fa fa-pencil-square"></i></a>&nbsp;|</td>
</tr>
<?php
}?>
</tbody>
