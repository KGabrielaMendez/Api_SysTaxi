...
//$LONGITUD_CAR = isset($_REQUEST['LONGITUD_CAR']) ? addslashes($_REQUEST['LONGITUD_CAR']) : '';
$DIRECCION_CAR = isset($_REQUEST['DIRECCION_CAR']) ? addslashes($_REQUEST['DIRECCION_CAR']) : '';
$sqlI = "INSERT INTO cat_carrera (ID_PEDIDO, DESCRIPCION_CAR, DISTANCIA_CAR, TIEMPOESPERAMIN_CAR, COSTO_CAR, DIRECCION_CAR) VALUES ('$ID_PEDIDO', '$DESCRIPCION_CAR', '$DISTANCIA_CAR', '$TIEMPOESPERAMIN_CAR', '$COSTO_CAR', '$DIRECCION_CAR')";
